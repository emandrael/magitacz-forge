...
public class AttachmentLootCategories {
    ...
    public AttachmentLootCategories() {
    }
    ...
    public static void init() {
        MUZZLE = register("muzzle", AttachmentPredicate.matchIndex(AttachmentLootCategories::isMuzzle), EquipmentSlot.MAINHAND);
        EXTENDED_MAG = register("extended_mag", AttachmentPredicate.matchIndex(AttachmentLootCategories::isExtendedMagazine), EquipmentSlot.MAINHAND);
        LASER = register("laser", AttachmentPredicate.matchIndex(AttachmentLootCategories::isLaser), EquipmentSlot.MAINHAND);
        GRIP = register("grip", AttachmentPredicate.matchIndex(AttachmentLootCategories::isGrip), EquipmentSlot.MAINHAND);
        STOCK = register("stock", AttachmentPredicate.matchIndex(AttachmentLootCategories::isStock), EquipmentSlot.MAINHAND);
        SCOPE = register("scope", AttachmentPredicate.matchIndex(AttachmentLootCategories::isScope), EquipmentSlot.MAINHAND);
    }
