...
public class Config {
    ...
    public static final ForgeConfigSpec.BooleanValue INJECT_CHEST_LOOT_TABLES = BUILDER.comment("Whether to inject chests with Magitacz Loot!").define("injectChestLoot", true);
